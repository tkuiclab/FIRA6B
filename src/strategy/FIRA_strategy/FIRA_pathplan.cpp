...
//            printf("full speed pullback\n");
    ...
    if( fabs(opgoal_angle) > 30 ){
        if(opgoal_angle > 0){
            yaw = (opgoal_angle - 180)/2;
        }else{
            yaw = (180 - opgoal_angle)/2;
        }
//        printf("angle_fix middle\n");

#ifndef _GAZEBO_SOCCER_PLUGIN_HH_
#define _GAZEBO_SOCCER_PLUGIN_HH
...
namespace gazebo
{
class SoccerPlugin: public ModelPlugin
{
private:
...
public:
    ...
    void Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
    {
        ...
        boost::bind(&SoccerPlugin::OnUpdate, this));
  ...
  GZ_REGISTER_MODEL_PLUGIN(SoccerPlugin)
}

...
input		[31:0]	iFB_Motor4,		// Feedback of motor4
...
*/
		...
		rData[7:0]		<=	8'hFF;
		rData[15:8]		<=	8'hFA;
		rData[23:16]	<=	all[55:48];
		rData[31:24]	<=	all[47:40];
		rData[39:32]	<=	all[39:32];
		rData[47:40]	<=	all[31:24];
		rData[55:48]	<=	all[23:16];
		rData[63:56]	<=	all[15:8];
		rData[71:64]	=	crc[55:48];		
